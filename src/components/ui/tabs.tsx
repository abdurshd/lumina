...
function TabsTrigger({
  ...
  return (
    ...
    >
      {children}
      <TabsIndicator shouldReduceMotion={shouldReduceMotion ?? false} />
    </TabsPrimitive.Trigger>
  )
}

function TabsIndicator({ shouldReduceMotion }: { shouldReduceMotion: boolean }) {
  return (
    <motion.div
      layoutId="tabs-indicator"
      className="absolute opacity-0 bg-foreground group-data-[variant=line]/tabs-list:data-[state=active]:opacity-100 group-data-[orientation=horizontal]/tabs:inset-x-0 group-data-[orientation=horizontal]/tabs:bottom-[-5px] group-data-[orientation=horizontal]/tabs:h-0.5 group-data-[orientation=vertical]/tabs:inset-y-0 group-data-[orientation=vertical]/tabs:-right-1 group-data-[orientation=vertical]/tabs:w-0.5"
      data-state="active"
