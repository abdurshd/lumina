...
export function WebcamPreview({ videoRef, isActive }: WebcamPreviewProps) {
  return (
    <div className="relative aspect-square w-full max-w-md overflow-hidden rounded-2xl glass">
      <video
        ref={videoRef}
        autoPlay
        playsInline
      ...
      {!isActive && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-muted-foreground">
            <div className="mx-auto mb-2 h-16 w-16 rounded-full bg-white/[0.04] flex items-center justify-center">
