      ...
      >
        <defs>
          <radialGradient id="brain-glow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="oklch(70% 0.12 148 / 0.15)" />
            <stop offset="60%" stopColor="oklch(70% 0.12 148 / 0.04)" />
        ...
        <g stroke="oklch(70% 0.12 148 / 0.04)" strokeWidth="0.5">
        ...
        <g transform="translate(960, 540) scale(1.3)" stroke="var(--primary)" strokeWidth="1">

          {/* Left hemisphere facets */}
          <path d="M-20 -90 L-100 -60 L-80 -10 L-20 -30 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '0s' }} />
          <path d="M-100 -60 L-160 -20 L-140 40 L-80 -10 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '0.4s' }} />
          <path d="M-160 -20 L-200 30 L-170 80 L-140 40 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '0.8s' }} />
          <path d="M-80 -10 L-140 40 L-100 90 L-30 60 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '1.2s' }} />
          <path d="M-140 40 L-170 80 L-120 110 L-100 90 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '1.6s' }} />
          <path d="M-20 -30 L-80 -10 L-30 60 L-20 20 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '2.0s' }} />

          {/* Right hemisphere facets */}
          <path d="M20 -90 L100 -60 L80 -10 L20 -30 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '0.2s' }} />
          <path d="M100 -60 L160 -20 L140 40 L80 -10 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '0.6s' }} />
          <path d="M160 -20 L200 30 L170 80 L140 40 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '1.0s' }} />
          <path d="M80 -10 L140 40 L100 90 L30 60 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '1.4s' }} />
          <path d="M140 40 L170 80 L120 110 L100 90 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '1.8s' }} />
          <path d="M20 -30 L80 -10 L30 60 L20 20 Z" fill="oklch(70% 0.12 148 / 0.05)" className="svg-pulse-fill" style={{ animationDelay: '2.2s' }} />

          {/* Central bridge */}
          <path d="M-20 -90 L20 -90 L20 -30 L-20 -30 Z" fill="oklch(70% 0.12 148 / 0.03)" className="svg-pulse-fill" style={{ animationDelay: '0.3s' }} />
          <path d="M-30 60 L30 60 L20 20 L-20 20 Z" fill="oklch(70% 0.12 148 / 0.03)" className="svg-pulse-fill" style={{ animationDelay: '1.5s' }} />
          ...
          <circle cx="-20" cy="-90" r="3" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '0s' }} />
          <circle cx="20" cy="-90" r="3" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '0.3s' }} />
          <circle cx="-100" cy="-60" r="2.5" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '0.6s' }} />
          <circle cx="100" cy="-60" r="2.5" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '0.9s' }} />
          <circle cx="-160" cy="-20" r="2" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '1.2s' }} />
          <circle cx="160" cy="-20" r="2" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '1.5s' }} />
          <circle cx="-200" cy="30" r="2" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '1.8s' }} />
          <circle cx="200" cy="30" r="2" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '2.1s' }} />
          <circle cx="-120" cy="110" r="2.5" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '2.4s' }} />
          <circle cx="120" cy="110" r="2.5" fill="var(--primary)" className="svg-pulse-node" filter="url(#brain-node-glow)" style={{ animationDelay: '2.7s' }} />
        </g>
        ...
        <g className="svg-drift" style={{ animationDuration: '12s' }}>
          <g transform="rotate(-15 620 320)">
            ...
            <circle cx="595" cy="370" r="5" fill="oklch(70% 0.12 148 / 0.3)" stroke="oklch(70% 0.12 148 / 0.4)" strokeWidth="1" />
            <line x1="608" y1="370" x2="650" y2="370" stroke="oklch(70% 0.12 148 / 0.15)" strokeWidth="2" />
          </g>
        </g>
        ...
        <g className="svg-drift" style={{ animationDuration: '16s', animationDelay: '6s' }}>
          <g transform="rotate(-8 550 720)">
            ...
            <rect x="520" y="750" width="55" height="6" rx="3" fill="color-mix(in oklch, var(--primary) 10%, transparent)" />
          </g>
        </g>
        ...
        <g className="svg-drift" style={{ animationDuration: '13s', animationDelay: '2s' }}>
          <g transform="rotate(5 1400 250)">
            ...
            <circle cx="1375" cy="270" r="5" fill="oklch(70% 0.12 148 / 0.2)" stroke="oklch(70% 0.12 148 / 0.3)" strokeWidth="1" />
        ...
        <g className="svg-drift" style={{ animationDuration: '15s', animationDelay: '8s' }}>
          <g transform="rotate(12 1350 750)">
            ...
            <rect x="1320" y="770" width="60" height="14" rx="7" fill="color-mix(in oklch, var(--primary) 10%, transparent)" stroke="oklch(70% 0.12 148 / 0.2)" strokeWidth="0.5" />
          </g>
        </g>
      </svg>
    </div>
