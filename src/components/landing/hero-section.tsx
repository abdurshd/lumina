    ...
    return (
        <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 text-center">
                ...
                {/* Badge */}
                <ScrollReveal variants={fadeInUp} className="mb-8 inline-flex items-center gap-2 rounded-full bg-primary/10 border-2 border-primary/20 px-5 py-2 text-sm font-bold text-primary uppercase tracking-wide backdrop-blur-sm">
                ...
                >
                    <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                        Lumina uses AI to analyze your digital footprint, conduct a live video interview, and illuminate your hidden career potential.
                    </p>
                </ScrollReveal>
